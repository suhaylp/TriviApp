...
// Represents a writer that writes JSON representation of AllTrivia to file
public class JsonWriter {
    ...
    // MODIFIES: this
    // EFFECTS: writes JSON representation of allTopics to file
    public void write(AllTopics at) {
